core/nginx.c/main:   ngx_slab_sizes_init();
core/ngx_cycle.c/ngx_init_cycle => core/ngx_cycle.c/ngx_init_zone_pool=>ngx_slab_init
```
...
typedef struct {
    ...
    ngx_slab_page_t  *pages;		// slab page管理结构的开始位置
    ngx_slab_page_t  *last;
    ngx_slab_page_t   free;			// 空闲的slab page管理结构链表

    ngx_slab_stat_t  *stats;
    ngx_uint_t        pfree;

    u_char           *start;		// pages数组的的起始位置
    u_char           *end;			// 整个slab pool 的结束位置
...
```
![slab.png](https://upload-images.jianshu.io/upload_images/1697198-432d8d3c8692ec50.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)




https://blog.csdn.net/u013009575/article/details/17743261
